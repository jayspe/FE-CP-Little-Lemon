...
export default function ReservationForm(props) {
    ...
    return (
       <form className="reservation-form" onSubmit={handleSubmit}>
            ...
            <div>
                <br></br>
                <small><p><strong>Note that you cannot edit your reservation after submission. Please double-check your answers.
                    </strong></p></small>
                    <button type="submit" className="action-button">Book a table</button>
            </div>
       </form>
    );
}